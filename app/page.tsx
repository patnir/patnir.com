...
export default function Home() {
  return (
    <div className="container relative">
      <div className="pr-4">
        <p>
          I live in Seattle. I work at <a href="https://ironfish.network" target="_blank" className="text-blue-600">Ironfish</a> (backed by a16z, sequoia). Previously, I worked at <a href="https://atomic.vc" target="_blank" className="text-blue-600">Atomic</a>, <a href="https://ridgelineapps.com" target="_blank" className="text-blue-600">Ridgeline</a>, and Microsoft.
        </p>
